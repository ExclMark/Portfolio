...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    localStorage.setItem("previousProject", 2)
    ...
    function project(span) {
        if (loaded) {
            textElement.innerHTML = `<span class='pwd'>./projects/rpoxubot - [${page}/${totalPages}]</span>\n\n`;
    ...
    function updateHeader() {
        ...
        text += localization.project.name + " " + localization.project.rpoxubot.name + "\n";
        text += localization.project.desc + " " + localization.project.rpoxubot.desc + "\n";
        text += localization.project.tech + " " + localization.project.rpoxubot.tech + "\n";
        text += localization.project.link + " " + localization.project.rpoxubot.link + "\n";
        ...
        span.className = 'pwd';
        textElement.appendChild(span);
        span.textContent = `./projects/rpoxubot - [${page}/${totalPages}]\n\n`;
        currentMenuIndex = 0;
        loaded = false;
        project();
    }
